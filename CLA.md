...
of, publicly display, publicly perform, and distribute Your contributions,
and to license and relicense Your contributions and derivative works of them
...
licenses. If an employer has rights to intellectual property You create, You
represent that You are authorized to submit the contribution on its behalf
or that it has waived such rights for the contribution. If You wish to
submit work that is not Your original creation, submit it separately from
any contribution, identifying its source and license terms — this agreement
does not cover it.

Except for the representations above, Your contributions are provided
"AS IS", without warranties or conditions of any kind, and You are under no
obligation to provide support for them.
