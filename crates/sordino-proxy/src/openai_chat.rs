...
async fn chat_completions_inner(
    ...
    // x-sordino-conversation naming a LIVE pin must refuse (409) rather than route to the
...
/// Chat-completions counterpart of [`crate::walk::mask_request_disabled`]: mask this
/// request as if masking were OFF for its conversation (passthrough except the A9
