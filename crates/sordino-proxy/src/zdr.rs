...
//!
//! This is the **Trust** switch — the third of sordino's three orthogonal switches
...
//!     serialized into the 0600 state file, the `GET /sordino/config` snapshot, or
...
pub fn resolve_targets(section: &ZdrSection) -> ResolvedZdr {
    ...
    // `/sordino:zdr` with no arg can never silently engage nothing.
